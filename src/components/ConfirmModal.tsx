...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-2200 flex items-center justify-center bg-black/35 p-4">
      <div className="card w-full max-w-115" role="dialog" aria-modal="true" aria-label={title}>
        <h3 className="mb-2 text-lg font-semibold text-(--gray1)">{title}</h3>
        <div className="mb-4.5 text-sm text-(--gray3)">{message}</div>
